...
```{r folytonos}
#flexdashboardot mega  apandert kitöröltemxasd
#rossz szoras es varhato valoszinu
#chart-line
                                  ...
                                  fluidRow(column(9,
                                           ...
                                           column(3,
                                                  tabBox(width = "110%",side="right",
                                                         ...
                                                         tabPanel("Szórás",uiOutput('binom_ex2')),
                                                         tabPanel("Várható érték",uiOutput('binom_ex3')))
                                                  )),
